    ...
    return (
        ...
        <section className="flex py-[5rem] max-lg:py-[3rem] max-lg:flex-col max-lg:gap-[7rem] items-center">
            ...
            <div onMouseOver={() => setIsMouseOver(true)} onMouseLeave={() => setIsMouseOver(false)} className={`max-lg:w-full flex-1 text-[5rem] max-md:text-[3rem] flex justify-center items-center relative max-w-[90%] ${theme == 'dark' && 'text-codGray-500'}`}>
                <div className={`w-[15rem] max-md:w-[12rem] h-[15rem] max-md:h-[12rem] shadow-2xl shadow-bitterSweet-500 bg-gallary-500 rounded-full flex justify-center items-center transition-all duration-300 ${isMouseOver && "rotate-[360deg]"}`}>
