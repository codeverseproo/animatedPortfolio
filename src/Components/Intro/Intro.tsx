...
export default function Intro() {
    ...
    return (
        <section className="flex justify-center items-center gap-[2rem] max-lg:gap-[4rem] py-[5rem] max-md:py-[2rem] max-lg:flex-col">
            ...
            <div className="max-md:w-full w-1/2 flex-1 flex justify-center items-center relative">
                ...
                <img src={mustaches} className="absolute max-md:max-w-[10%] max-w-[10%] left-0 top-0 hover:scale-105 transition-all duration-75" />
                <div className={`${theme == 'dark' && "text-codGray-500"} bg-gallary-500 flex ring-1 ring-pictonBlue-500 gap-[1rem] px-[1rem] py-[0.5rem] rounded-lg absolute -top-[2rem] -right-[2rem] z-10 shadow-2xl shadow-bitterSweet-500 hover:scale-105 transition-all duration-75`}>
